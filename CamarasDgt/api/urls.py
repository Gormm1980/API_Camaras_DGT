...
from CamerasMadrid.views import CamerasComMadrid_APIView, CamerasComMadrid_APIView_Detail
from CamerasCat.views import CamerasCat_APIView, CamerasCat_APIView_Detail
